...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'\\src\\Carto\\UserBundle\\Entity'))), 'Carto\\UserBundle\\Entity');
        ...
        $b->setEntityNamespaces(array('CartoUserBundle' => 'Carto\\UserBundle\\Entity'));
